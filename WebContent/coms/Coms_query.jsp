...
<div id="navi">
	<div id='naviDiv'>
		...
		<span><img src="../images/arror.gif" width="7" height="11" border="0" alt=""></span>&nbsp;<a href="<%=path%>/students/Students_query.action">单位查询</a><span>&nbsp;
	</div>
</div>
<div id="tips">
</div>
...
<form name="addForm" action="<%=path%>/coms/Com_comquery.action" method="post">
